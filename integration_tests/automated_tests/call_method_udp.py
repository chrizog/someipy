...
class TestCallMethodUdp(TestBase):
    ...
    def __init__(self, repository, ld_library_path=None, interface_ip="127.0.0.1"):
        ...
        self.vsomeip_app = [
            f"{repository}/integration_tests/install/call_method_udp/call_method_udp"
        ]
        self.someipy_app = [
            "python3",
        ...
        self.vsomeip_config = f"{repository}/integration_tests/install/call_method_udp/vsomeip-client.json"
